...
uses ContaCorrenteDM, EntradaDM, SaidaDM, ConexaoDM, FerramentasForm,
  NovaEntradaForm, NovaSaidaForm, ConexaoForm, ConfiguracoesForm, ExtratoForm;
...
procedure TPrincipalFrm.actExtratoExecute(Sender: TObject);
begin
  Application.CreateForm(TExtratoFrm,ExtratoFrm);
  try
    ExtratoFrm.ShowModal;
  finally
    FreeAndNil(ExtratoFrm);
  end;
end;
